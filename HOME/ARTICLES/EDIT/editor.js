...
let post = document.getElementById("write_part").value ;
...
function get_write() {
    ...
    document.getElementById("see_preview1").value=get_final_code();
}
...
function check_html_codes(get_html_codes) {
    let html_codes = ["cen", "h1", "h2", "h3", "h4", "h5", "h6", "p","b","i"];
...
function get_final_code() {
    let html_codes = ["cen", "h1", "h2", "h3", "h4", "h5", "h6", "p","b","i"];
    let original_html_codes = ["center", "h1", "h2", "h3", "h4", "h5", "h6", "p","b","i"];
    let final = "";
