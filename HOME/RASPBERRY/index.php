...
$sql="SELECT * FROM create_questions WHERE category='RASPBERRY' ORDER BY id DESC";
...
<center>
        <span style="float: left;"><span><b>From :</b> <?php echo $row["username"]; ?></span></span><span style="float: right;">posted on <?php echo $row["time1"]; ?></span>
</center>
</div>
    </div>
